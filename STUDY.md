...
- [ ] **Persistenza con database** — iniziato in `08-database-notes/`: sostituire dati in memoria con un database semplice. Concetti: `database/sql`, driver, connessione DB, query `SELECT/INSERT/UPDATE/DELETE`, migrazioni minime, gestione errori, repository layer.
