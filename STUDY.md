...
- [ ] **Strutturazione progetto multi-file** — iniziato in `07-project-structure/`: prendere un progetto già fatto e separare `main.go` in package/file dedicati e `App.tsx` in componenti/file reali. Concetti: separazione responsabilità, props tra componenti, import/export, package Go, handler/service/model, organizzazione cartelle.
